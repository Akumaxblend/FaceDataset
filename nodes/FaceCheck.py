...
class FaceCheck(desc.CommandLineNode):
    ...
    def processChunk(self, chunk):
        ...
        self.commandLine = "python " + self.pointsDrawerDirectory.as_posix() + " --seed " + str(start) + " --batch " + str(chunkSize) + " --inpaintDir {inputImageValue} --gtDir {groundTruthValue} --outPutDir {outputFolderValue} --threshold {thresholdValue} --visibleOnly {visibleOnlyValue}"
        super(FaceCheck, self).processChunk(chunk)